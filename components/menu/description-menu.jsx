...
const DescriptionMenu = () => {
    return (
        <div className="p-4 border-secondary border-[1px] rounded-lg my-5">
            <h4>Spesifikasi Produk</h4>
            <h4 className="mt-5">Detail</h4>
            <div>
                <p>Colorway : White</p>
                <p>Article : (CZ4938-100)</p>
                <p>Brand New in Box / Tag (BWNT)</p>
                <p>Material : Fabric & Leather</p>
